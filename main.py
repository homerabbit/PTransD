...
#加载测试数据
#test_dataloader = TestDataLoader(in_path="./benchmarks/FB15K237/",entity_set=train_dataloader.entity_set,train_triple = train_dataloader.triple_list,sample_mode="link")
