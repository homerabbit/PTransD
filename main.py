...
#加载测试数据
test_dataloader = TestDataLoader(in_path="./benchmarks/WN18/",test_file = "test2id.txt",entity_set=set(train_dataloader.entity2id.values()),train_triple = train_dataloader.triple_list,sample_mode="link")
